...
QT_MOC_LITERAL(1, 12, 11), // "eventhappen"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5) // "event"

    },
    "EventThread\0eventhappen\0\0event"
};
...
void EventThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (EventThread::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventThread::eventhappen)) {
                *result = 0;
                return;
            }
        }
